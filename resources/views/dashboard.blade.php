...
<section class="sec-cards">
  ...
  <div class="dash-cards">
    <a href="/all-students" class="dash-card border-blue">
      <div class="card-text">All Students</div>
    </a>
  ...
  <div class="quick-info-card">
    ...
    <div class="body">
      <div class="stats">
        ...
        <div class="num-content">K.C.P.E</div>
      </div>
      <div class="stats">
        ...
        <div class="num-content">Corona Series</div>
      </div>
      <div class="stats">
        ...
        <div class="num-content">Laikipia East</div>
      </div>
      <div class="stats">
        ...
        <div class="num-content">Jersy</div>
      </div>
        </div>
  </div>
...
<div class="quick-info-card">
  <div class="header">
    <i class="fa fa-trophy fa-lg" style="color: #3498db; margin-right: 5px"></i>
    <h4>TOP PERFOMERS</h4>
  </div>
  <div class="body">
<div class="stats">
